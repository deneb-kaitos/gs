...
export class Handlers {
  ...
  async start() {
    ...
    this.#debuglog(`${this.constructor.name}.start`, this.#redisClient);
  ...
  async message(ws, msg, isBinary) {
    ...
    await this.#redisClient.executeIsolated(async (isolatedClient) => {
      await isolatedClient.xAdd(this.#sinkStreamName, this.#AUTOGENERATED_ID, streamMessage, this.#streamOpts);
    });
